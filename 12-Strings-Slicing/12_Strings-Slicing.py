...
#Rule of Slicing: Python tries to go from the start index up to (but not including) the end index by stepping forward one character at a time,but not backwards.
